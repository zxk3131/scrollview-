...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [QHSliderViewController sharedSliderController].finishShowRight = ^()
    {
     ...
     self.main = [[MainAppViewController alloc] init];
    [QHSliderViewController sharedSliderController].MainVC = self.main;
    ...
    [UMSocialData setAppKey:@"5433d6a5fd98c5cb180207fb"];
